        ...
        <div class="row">
            <div class="mbr-box mbr-box--fixed mbr-box--adapted">
                ...
                <c:forEach var="list"  begin="6" end="6" items="${command}"> 
                    <figure class="mbr-figure mbr-figure--adapted mbr-figure--caption-inside-bottom mbr-figure--full-width"><img src="<c:url value="${list['foto']}"/>"></figure>
                </div>
...
<section class="mbr-section mbr-section--relative mbr-section--fixed-size" id="features1-17" style="background-color: rgb(204, 204, 204);">
        ...
        <div class="mbr-section__row row">
            <div class="mbr-section__col col-xs-12 col-sm-6">
                ...
                <c:forEach var="list"  begin="0" end="0" items="${command}"> 
                    <figure class="mbr-figure"><img src="<c:url value="${list['foto']}"/>" class="mbr-figure__img"></figure>
                </div>
                <div class="mbr-section__container mbr-section__container--middle">
...
<section class="mbr-section mbr-section--relative mbr-section--fixed-size" id="features1-24" style="background-color: rgb(239, 239, 239);">
...
<section class="mbr-section mbr-section--relative mbr-section--fixed-size" id="social-buttons1-27" style="background-color: rgb(255, 255, 255);">
